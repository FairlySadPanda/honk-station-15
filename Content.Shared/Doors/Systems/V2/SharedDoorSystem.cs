...
using Content.Shared.Doors.Components.V2;
...
namespace Content.Shared.Doors.Systems.V2;
...
public abstract partial class SharedDoorSystem : EntitySystem
{
    ...
    public bool HasAccess(Entity<DoorComponent> door, EntityUid? user = null, AccessReaderComponent? access = null)
    {
        ...
        if (door.Comp.State == DoorState.Closed && TryComp<DoorAlarmComponent>(door, out _))
            return true;
